 ...
 * Widget Name: Team 1
 */
class Polishe_Team extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Member Team', 'polishe' ),
			]
		);
		...
		$repeater->add_control(
		    ...
		    [
		        ...
		        'default' => esc_html__( 'Social', 'polishe' ),
		    ]
	    );
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default'     => [
		            [
		             	'title'       => esc_html__( 'Twitter', 'polishe' ),
		                'social_link' => esc_html__( 'https://www.twitter.com/', 'polishe' ),
		                'social_icon' => [
							'value' => 'fab fa-twitter',
							'library' => 'fa-brand',
						],
		            ...
		            [
		             	'title'       => esc_html__( 'Facebook', 'polishe' ),
		                'social_link' => esc_html__( 'https://www.facebook.com/', 'polishe' ),
		                'social_icon' => [
		            ...
		            [
		             	'title'       => esc_html__( 'Pinterest', 'polishe' ),
		                'social_link' => esc_html__( 'https://www.pinterest.com/', 'polishe' ),
		                'social_icon' => [
		...
		$this->add_control(
			'bg_hover_des_color',
			[
				'label' => __( 'Extra/Job Color', 'polishe' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'plus_color',
			[
				'label'     => esc_html__( 'Plus Color', 'polishe' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'plus_bg',
			[
				'label'     => esc_html__( 'Plus Background', 'polishe' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
...
// After the Polishe_Team class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Polishe_Team() );