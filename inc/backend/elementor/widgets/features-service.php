 ...
 * Widget Name: Button
 */
class Polishe_Features_Service extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Features Service', 'polishe' );
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Service Title', 'polishe' ),
				'placeholder' => __( 'Service Title', 'polishe' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'polishe' ),
			]
		);
		$repeater->add_control(
			'link',
		...
		$this->add_control(
			'fservice_lists',
			[
				'label' => __( 'Features Service List Items', 'polishe' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'fservice_number' => __( '01', 'polishe' ),
						'fservice_title' => __( 'Title #1', 'polishe' ),
						'fservice_content' => __( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'polishe' ),
						'link' => '#',
					],
					[
						'fservice_number' => __( '02', 'polishe' ),
						'fservice_title' => __( 'Title #2', 'polishe' ),
						'fservice_content' => __( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'polishe' ),
						'link' => '#',
					],
				],
		...
		$this->add_control(
			'btn_text',
			[
				'label' => __( 'Label Button', 'polishe' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More', 'polishe' ),
			]
		);
...
// After the Polishe_Features_Service class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Polishe_Features_Service() );