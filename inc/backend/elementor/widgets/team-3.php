 ...
 * Widget Name: Team 3
 */
class Polishe_Team3 extends Widget_Base{
...
// After the Polishe_Team3 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Polishe_Team3() );