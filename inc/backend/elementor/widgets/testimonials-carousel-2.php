 ...
 */
class Polishe_Testimonials2 extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Testimonial Carousel 2', 'polishe' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'arrow_align',
			[
				'label' => __( 'Arrows Align', 'polishe' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'middle'   => __( 'Middle', 'polishe' ),
					'bottom'   => __( 'Bottom', 'polishe' ),
				],
				'default' => 'middle',
				'prefix_class' => 'arrows-',
				'condition' => [
		...
		$this->add_control(
			'dots_style',
			[
				'label' => __( 'Dots Style', 'polishe' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'vertical'   => [
						'title' => esc_html__( 'Vertical', 'polishe' ),
						'icon'  => 'fa fa-ellipsis-v',
					],
					'horizontal' => [
						'title' => esc_html__( 'Horizontal', 'polishe' ),
...
Plugin::instance()->widgets_manager->register( new Polishe_Testimonials2() );