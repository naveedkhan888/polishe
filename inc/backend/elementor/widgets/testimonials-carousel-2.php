 ...
 */
class Bistroly_Testimonials2 extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Testimonial Carousel 2', 'bistroly' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'arrow_align',
			[
				'label' => __( 'Arrows Align', 'bistroly' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'middle'   => __( 'Middle', 'bistroly' ),
					'bottom'   => __( 'Bottom', 'bistroly' ),
				],
				'default' => 'middle',
				'prefix_class' => 'arrows-',
				'condition' => [
		...
		$this->add_control(
			'dots_style',
			[
				'label' => __( 'Dots Style', 'bistroly' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'vertical'   => [
						'title' => esc_html__( 'Vertical', 'bistroly' ),
						'icon'  => 'fa fa-ellipsis-v',
					],
					'horizontal' => [
						'title' => esc_html__( 'Horizontal', 'bistroly' ),
...
Plugin::instance()->widgets_manager->register( new Bistroly_Testimonials2() );