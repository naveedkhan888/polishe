 ...
 * Widget Name: Search
 */
class Polishe_Search extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Search Header', 'polishe' );
	}
...
// After the Polishe_Search class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Polishe_Search() );