 ...
 */
class Polishe_Menu_Mobile extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Menu Mobile', 'polishe' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'pos_menu',
			[
				'label' => __( 'Position', 'polishe' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'on-right',
				'options' => [
					'on-left' 	=> __( 'On Left', 'polishe' ),
					'on-right'  => __( 'On Right', 'polishe' ),
				]
			]
		);
		...
		$this->add_control(
			'color_back',
			[
				'label' => __( 'Back Button Color', 'polishe' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
// After the Polishe_Menu_Mobile class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Polishe_Menu_Mobile() );